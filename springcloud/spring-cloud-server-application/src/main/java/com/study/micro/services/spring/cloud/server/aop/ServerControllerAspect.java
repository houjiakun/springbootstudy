package com.study.micro.services.spring.cloud.server.aop;

import com.study.micro.services.spring.cloud.server.annotation.SemaphoreCircuitBreaker;
import com.study.micro.services.spring.cloud.server.annotation.TimeoutCircuitBreaker;
import com.study.micro.services.spring.cloud.server.controller.ServerController;
...
public class ServerControllerAspect {
    ...
    @Around("execution(* com.study.micro.services.spring.cloud." +
